...
public abstract class MVID_SessionStorage
{
	...
	*/
	public abstract Boolean save(string storage_name, string mv_session_id);
	...
	*/
	public abstract string load(string storage_name);
}